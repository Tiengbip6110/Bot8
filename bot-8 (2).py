...
import os
bot_token = os.environ.get('8635633710:AAGI6L1tJ4FZAUIYv7__jJhLjSDaOUDvPls')
if not bot_token:
    raise ValueError('BOT_TOKEN environment variable not set')# nhập token bot

bot = telebot.TeleBot(bot_token)
start_time = time.time()
allowed_group_id = -5101035864  # Danh sách các ID nhóm cho phép, bạn có thể thêm các ID khác vào đây
